...
public class TodoService {
    ...
    public Page<TodoSearchResponse> searchTodos(int page, int size, String title, String startDate, String endDate, String nickName) {
        Pageable pageable = PageRequest.of(page - 1, size);
        ...
        return todoRepository.searchTodos(pageable, title, start, end, nickName);
    }
}
